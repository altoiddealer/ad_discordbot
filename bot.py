...
####################### MOSTLY IMAGE GEN PROCESSING #########################
    ...
    def init_img_payload(self:Union["Task","Tasks"]):
        try:
            ...
            self.params.mode = imgcmd_params.get('mode', 'txt2img')
...
class LLMState(SettingsBase):
    def __init__(self):
        ...
        self.state = {
            ...
            'sampler_priority': ['repetition_penalty', 'presence_penalty', 'frequency_penalty', 'dry', 'top_n_sigma', 'temperature', 'dynamic_temperature', 'quadratic_sampling', 'top_k', 'top_p', 'typical_p', 'epsilon_cutoff', 'eta_cutoff', 'tfs', 'top_a', 'min_p', 'adaptive_p', 'mirostat', 'xtc', 'encoder_repetition_penalty', 'no_repeat_ngram'],
